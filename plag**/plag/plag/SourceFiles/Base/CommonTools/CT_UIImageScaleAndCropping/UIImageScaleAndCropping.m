...
#import "UIImageScaleAndCropping.h"

CGFloat DegreesToRadians(CGFloat degrees) {return degrees * M_PI / 180;};
CGFloat RadiansToDegrees(CGFloat radians) {return radians * 180/M_PI;};

@implementation UIImage(UIImageScaleAndCropping)
...
//等比例缩放
-(UIImage*)scaleToTargetSize:(CGSize)size
{
    CGFloat imageWidth = CGImageGetWidth(self.CGImage);
    CGFloat imageHeight = CGImageGetHeight(self.CGImage);
    
    float targetWidht = size.width;
    float targetHeight = (imageHeight / imageWidth) * targetWidht;
    
    int xPos = 0;
    int yPos = (targetHeight-size.height)/2;
    UIGraphicsBeginImageContext(CGSizeMake(size.width, size.height));
    [self drawInRect:CGRectMake(xPos, -yPos, targetWidht, targetHeight)];
